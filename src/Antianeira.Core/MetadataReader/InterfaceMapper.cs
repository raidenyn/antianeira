...
namespace Antianeira.MetadataReader
{
    ...
    public class DefaultInterfaceMapper : IInterfaceMapper
    {
        ...
        public Interface GetInterface([NotNull] Type type, [NotNull] TypeContext context)
        {
            ...
            return context.Definitions.Interfaces.GetOrCreate(name, () => Map(name, type, context));
        }

        private Interface Map([NotNull] string name, [NotNull] Type type, [NotNull] TypeContext context) {
